...
pub trait BroadcastView {
    ...
    where
        Self: Sized;
    fn network_task_view(&self) -> Element<Message>
    where
        Self: Sized;
...
impl BroadcastView for GUIState {
    ...
    where
        Self: Sized,
    {
        let content = Container::new(scrollable(Column::new().spacing(10)))
            .height(Length::Fill)
        ...
        Self: Sized,
    {
        ...
        let title = Column::new()
            .spacing(10)
            .push(Text::new("Broadcast Work").size(24).style(Color::WHITE))
            .push(
        ...
        let requirements_row = Row::new().spacing(20).width(Length::Fill).push(
            Column::new()
        ...
        let payment_row = Row::new().spacing(20).width(Length::Fill).push(
            Column::new()
                .width(Length::Fixed(90.0))
                .spacing(5)
                .push(Text::new("Reward").size(14).style(label_color))
                .push(
                    TextInput::new("$0.00", &self.broadcast_form().reward)
                        .padding(10)
                        .size(input_height)
                        .width(Length::Fill)
        ...
        let form_content = Column::new()
            ...
            .push(payment_row)
            .push(Row::new().spacing(20).push(publish_button));
